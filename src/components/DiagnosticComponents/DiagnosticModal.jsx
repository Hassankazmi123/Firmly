...
const DiagnosticModal = () => {
    ...
    // detect completed variant: either path or query ?status=completed
    const isCompleted = location.pathname.endsWith("/completed") || new URLSearchParams(location.search).get("status") === "completed";
                    ...
                    <div className="flex items-center sm:space-x-4">
                        ...
                        <div className="relative" ref={ltDropdownRef}>
                            <button
                                ...
                                type="button"
                            >
                                <span className="text-sm lg:text-lg font-semibold bg-[#ababab] border border-white/20 text-white/70 px-4 py-3 rounded-2xl">
                                    LT
                                </span>
                                <svg
                            ...
                            {isMobileMenuOpen && (
                                ...
                                >
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 text-sm font-medium transition-colors ${selectedTab === "Dashboard" ? "text-[#6664D3]" : "text-gray-700 "
                                            }`}
                                        type="button"
                                    >
                                        Dashboard
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-3 text-sm font-medium border-t transition-colors ${selectedTab === "Amalia Corner" ? "text-[#6664D3]" : "text-gray-700"
                                            }`}
                                        type="button"
                                    >
                                        Amalia Corner
            ...
            <div className="flex-1 flex items-center justify-center border-[16px] border-[#f5f5f5] relative overflow-hidden bg-[#ebebeb] rounded-3xl">
                ...
                <div className="max-w-6xl w-full relative z-10">
                    ...
                    <div className="grid grid-cols-12 gap-12 items-start">
                        ...
                        <div className={`col-span-7 ${isCompleted ? "pt-0" : "pt-12 sm:pt-16 md:pt-20"}`}>
                            {isCompleted ? (
                                <>
                                    <div className="-mt-12 mb-6">
                                        <div className="w-20 h-20 sm:w-20 sm:h-20 rounded-full border-4 border-white  flex items-center justify-center shadow-lg">
                                            <span className="text-lg sm:text-xl font-semibold text-gray-800 font-inter">100%</span>
                                        </div>
                                    </div>
                                    ...
                                    <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-inter max-w-3xl">
                                        Excellent work! Your diagnostic assessment is now complete.<br/>
                                ...
                                <>
                                    ...
                                    <div className="mb-6">
                                        <div className="w-20 h-20 sm:w-20 sm:h-20 rounded-full border-4 border-[#a3a3a3] flex items-center justify-center bg-[#ebebeb] shadow-sm">
                                            <span className="text-lg sm:text-xl font-semibold text-gray-700 font-inter">0%</span>
                                        </div>
                                    </div>
                        ...
                        <div className="col-span-5 bg-white rounded-2xl p-8 shadow-md w-[500px] relative pt-12">
                            <div className={`absolute top-0 left-0 right-0 pointer-events-none overflow-hidden rounded-t-2xl ${isCompleted ? "bg-[#d46fa8]" : "bg-[#855cc9]"}`}>
                                <img
                            ...
                            {isCompleted ? (
                                <>
                                    <h3 className="mt-2 text-2xl font-semibold text-gray-800 mb-2 font-cormorant">You're set to a great start!</h3>
                                    <p className="text-sm text-gray-700 mb-6 font-inter">Remember, these scores aren't meant to discourage you — they're here to set a benchmark for your growth and celebrate the capabilities you already have.</p>
                                ...
                                <>
                                    ...
                                    <ul className="space-y-4 text-sm text-gray-700 font-inter">
                                        <li className="flex gap-3">
                                            ...
                                            <span>
                                                Read each statement and think about it in the context of your current work and workplace
                                            </span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="text-purple-600 font-bold min-w-fit">•</span>
                                            <span>
                                                Drag the slider along the scale: far left to strongly disagree, far right to strongly agree, or anywhere in between to match your level of agreement
                                            </span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="text-purple-600 font-bold min-w-fit">•</span>
                                            <span>
                                                Trust your instincts and respond honestly based on your current workplace experience
                                            </span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="text-purple-600 font-bold min-w-fit">•</span>
                                            <span>
                                                Click "Next" in the top right corner to move to the next question
                                            </span>
                                        </li>
                                        <li className="flex gap-3">
                                            <span className="text-purple-600 font-bold min-w-fit">•</span>
                                            <span>
                                               Remember, your authentic responses will give us the clearest picture of your leadership development opportunities
                                            </span>
                                        </li>
                                    </ul>
                                </>
