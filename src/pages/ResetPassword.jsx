            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="text-left">
                <label className="block text-white/80 text-xs sm:text-sm font-inter mb-2">
                  New Password <span className="text-[#F26767]">*</span>
                </label>
              ...
              <div className="text-left">
                <label className="block text-white/80 text-xs sm:text-sm font-inter mb-2">
                  Confirm Password <span className="text-[#F26767]">*</span>
                </label>
                <div className="relative">
                  <input
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full text-white/70 hover:text-white text-xs sm:text-sm font-inter transition-colors text-center"
              >
                Back to Login
              </button>
            </div>
